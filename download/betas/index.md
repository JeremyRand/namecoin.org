...
* [Electrum-NMC v3.3.7 for GNU/Linux, Windows, and macOS (Python tar.gz)](https://beta.namecoin.org/files/electrum-nmc/electrum-nmc-3.3.7/Electrum-NMC-3.3.7.tar.gz)
* [Electrum-NMC v3.3.7 for GNU/Linux, Windows, and macOS (Python zip)](https://beta.namecoin.org/files/electrum-nmc/electrum-nmc-3.3.7/Electrum-NMC-3.3.7.zip)
* [Electrum-NMC v3.3.7 for GNU/Linux (x86_64 AppImage)](https://beta.namecoin.org/files/electrum-nmc/electrum-nmc-3.3.7/electrum-nmc-nc3.3.7-x86_64.AppImage)
* [Electrum-NMC v3.3.7 for Windows (Standalone Executable)](https://beta.namecoin.org/files/electrum-nmc/electrum-nmc-3.3.7/electrum-nmc-nc3.3.7.exe)
* [Electrum-NMC v3.3.7 for Windows (Portable version)](https://beta.namecoin.org/files/electrum-nmc/electrum-nmc-3.3.7/electrum-nmc-nc3.3.7-portable.exe)
* [Electrum-NMC v3.3.7 for Windows (Installer)](https://beta.namecoin.org/files/electrum-nmc/electrum-nmc-3.3.7/electrum-nmc-nc3.3.7-setup.exe)
* [Electrum-NMC v3.3.7 for Android](https://beta.namecoin.org/files/electrum-nmc/electrum-nmc-3.3.7/Electrum_NMC-3.3.7.0-debug.apk)
* [Electrum-NMC v3.3.7 Signature (Release signed by Jeremy Rand)](https://beta.namecoin.org/files/electrum-nmc/electrum-nmc-3.3.7/SHA256SUMS.asc)

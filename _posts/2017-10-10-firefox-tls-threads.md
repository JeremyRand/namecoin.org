...
<object data="{{site.baseurl}}data/webextensions-latency/2017-10-07/graph-uncached.svg" type="image/svg+xml"><img src="{{site.baseurl}}data/webextensions-latency/2017-10-07/graph-uncached.png"></object>

<object data="{{site.baseurl}}data/webextensions-latency/2017-10-07/graph-cached.svg" type="image/svg+xml"><img src="{{site.baseurl}}data/webextensions-latency/2017-10-07/graph-cached.png"></object>

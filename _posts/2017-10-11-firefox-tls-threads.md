...
![Latency graph (uncached)]({{ "/data/webextensions-latency/2017-10-07/graph-uncached.png" | relative_url }})

![Latency graph (cached)]({{ "/data/webextensions-latency/2017-10-07/graph-cached.png" | relative_url }})
